...
class MetricsCollector:
    ...
    def record_execution_start(
        self, execution: JobExecution, worker_name: str = ""
    ) -> None:
    ...
    def record_execution_completion(
        self, execution: JobExecution, duration: float
    ) -> None:
    ...
    def record_execution_failure(
        self, execution: JobExecution, error: str, duration: float
    ) -> None:
    ...
    def record_execution_retry(self, execution: JobExecution) -> None:
    ...
    def record_dead_letter(self, execution: JobExecution) -> None:
