...
from services.communication.telegram_bot_service import start_application
from services.infrastructure.job_management.auto_discovery import (
    discover_and_register_tasks,
)
from services.infrastructure.job_management.job_manager import JobManager
from services.infrastructure.job_management.monitoring import (
    MetricsCollector,
    SystemMetrics,
)
...
class EnhancedStartupService:
    ...
    async def initialize_job_system(self):
        ...
        try:
            ...
            from services.infrastructure.job_management.decorators import JobRegistry
