...
from app.backend.models import ProposalFilter, ProposalType
from app.services.integrations.webhooks.chainhook.handlers.base_vote_handler import (
    BaseVoteHandler,
)
from app.services.integrations.webhooks.chainhook.models import Event
