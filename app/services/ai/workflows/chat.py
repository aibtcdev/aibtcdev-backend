...
from app.services.ai.workflows.utils.model_factory import create_planning_llm
...
class ChatService:
    ...
    def setup_callback_handler(self, queue, loop):
        from app.services.ai.workflows.workflow_service import BaseWorkflowService
    ...
    async def _execute_stream_impl(
        ...
        **kwargs,
        ...
        try:
            from app.services.ai.workflows.workflow_service import WorkflowBuilder
