...
from app.services.ai.workflows.agents.core_context import CoreContextAgent
from app.services.ai.workflows.agents.financial_context import FinancialContextAgent
from app.services.ai.workflows.agents.historical_context import HistoricalContextAgent
from app.services.ai.workflows.agents.image_processing import ImageProcessingNode
from app.services.ai.workflows.agents.reasoning import ReasoningAgent
from app.services.ai.workflows.agents.social_context import SocialContextAgent
from app.services.ai.workflows.base import BaseWorkflow
from app.services.ai.workflows.hierarchical_workflows import (
...
from app.services.ai.workflows.utils.model_factory import get_default_model_name
...
async def evaluate_proposal(
    ...
    # Use model name from app.config or default
