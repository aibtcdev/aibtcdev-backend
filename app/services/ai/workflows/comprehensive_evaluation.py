...
from app.services.ai.workflows.agents.evaluator import ComprehensiveEvaluatorAgent
from app.services.ai.workflows.agents.image_processing import ImageProcessingNode
from app.services.ai.workflows.agents.twitter_processing import TwitterProcessingNode
from app.services.ai.workflows.utils.models import (
...
async def evaluate_proposal_comprehensive(
    ...
    try:
        ...
        from app.services.ai.workflows.utils.models import EvaluationCategory
