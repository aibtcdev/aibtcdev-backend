...
<tweet>
  ...
  <text>{text}</text>
  <author_profile_data>{tweet_data.get("author_profile_data", "")}</author_profile_data>
  <author_pfp_analysis>{tweet_data.get("author_pfp_analysis", "")}</author_pfp_analysis>
  <author_keywords>{tweet_data.get("author_keywords", "")}</author_keywords>
  <tweet_images_analysis>{tweet_data.get("tweet_images_analysis", "")}</tweet_images_analysis>
</tweet>
"""
