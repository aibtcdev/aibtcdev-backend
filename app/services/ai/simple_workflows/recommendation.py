...
**FOCUS AREA:**
{focus_area if focus_area else "No specific focus area provided - recommend based on DAO mission and recent proposal patterns"}

**SPECIFIC NEEDS:**
{specific_needs if specific_needs else "No specific needs mentioned - identify opportunities based on DAO context"}
