...
OUTPUT: ONLY this JSON (start with '{' on first line, no extra text):
{{
  "current_order": int,
  "mission": int,
  "value": int,
  ...
  "safety": int,
  "growth": int,
  "reasons": {{ "key": "2-3 sentence rationale with specific evidence" for each }},
  "evidence": {{ "value_items": ["specific item 1", ...] }},
  "final_score": int,
  "confidence": float,
...
FINAL CHECK: Does this align with the current task? Cite evidence in reasons."""
