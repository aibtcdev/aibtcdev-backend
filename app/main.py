...
app.add_middleware(
    CORSMiddleware,
    allow_origin_regex=r"^(https://((sprint|sprint-faster|app|app-staging|staging)\.aibtc\.dev|aibtc\.dev|aibtc\.com|staging\.aibtc\.chat|[^.]+\.aibtcdev-frontend(-staging)?\.pages\.dev)|http://localhost:3000)$",
